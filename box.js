...
function createBox(name, host, num) {
    ...
    box.innerHTML = `
        <div class="flex gap-1 items-center my-1">
            ...
            <input type="text" placeholder="Name" value="${name}" class="name-input input input-xs w-24">
            <input type="text" placeholder="Host" value="${host}" class="host-input input input-xs flex-1 min-w-5">
